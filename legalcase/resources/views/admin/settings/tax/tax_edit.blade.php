    ...
    <div class="modal-dialog" role="document">
         <form action=" {{route('tax.update',$tax->id)}}" method="POST" id="tagForm" name="tagForm" >
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
             ...
             <input type="text" placeholder="" class="form-control" id="name" name="name" value="{{$tax->name ?? ''}}">
          </div>

          <div class="col-md-12 col-sm-12 col-xs-12 form-group">
              <label for="case_subtype">Tax Rate(%) <span class="text-danger">*</span></label>
              <input type="text" placeholder="" class="form-control" id="per" name="per" value="{{$tax->per ?? ''}}">
          </div>
